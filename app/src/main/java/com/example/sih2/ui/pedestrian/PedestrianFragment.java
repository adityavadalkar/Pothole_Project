package com.example.sih2.ui.pedestrian;
...
public class PedestrianFragment extends Fragment implements LocationListener {


    private static final int MY_PERMISSION_ACCESS_FINE_LOCATION=13;
    private DatabaseReference mDataBase;
    private StorageReference mStorageReference;
    private static final int MY_PERMISSION_ACCESS_COARSE_LOCATION=14;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_pedestrian, container, false);

        textureView = root.findViewById(R.id.texture);
        takePictureButton = root.findViewById(R.id.btn_takepicture);
        ...
        takePictureButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDataBase.child("Pedestrian").child("GPS_Lat").setValue(latd.getText().toString());
                mDataBase.child("Pedestrian").child("GPS_Long").setValue(lont.getText().toString());
               // mDataBase.child("Pedestrian").child("Image").setValue(uri.getPath());
    ...
    private void storeImageToFirebase() {
        ...
        mDataBase.child("Pedestrian").child("pic").setValue(base64Image);
   ...
   /* private void fileuploader()
    ...
    protected void takePicture() {
        ...
        try {
            ...
            final File file = new File(Environment.getExternalStorageDirectory().getPath() +"/pic.jpg");
                    ...
                    //try {
                       ...
                       /* OutputStream output = null;
                        try {
                                ...
                                //image.compress(Bitmap.CompressFormat.PNG,70,output);
                            } finally {
                                if (null != output) {
                                    output.close();
                                }
